...
--
-- Servidor: localhost
-- Tiempo de generación: 13-05-2021 a las 00:52:45
...
(6, 2, 1, '[{\"name\":\"OD\",\"value\":\"sdasd\"},{\"name\":\"OI\",\"value\":\"asd\"},{\"name\":\"observaciones\",\"value\":\"sdadasd\"}]'),
...
(6, 'sdasd', 'asdasd', 'asdasd', 3, 'asd', 'Alergias', 'Familiares', 2, 'asdasd', 'asdasd');
...
(3, 'Admin', 'Admin', '999999999', 'CEDULA DE CIUDADANIA', 'sogamoso', 'Masculino', 'admin@admin.com', '1111111', 'Activo', 'ADMINISTRADOR', 'cra 14 ', '2019-07-30', '$2y$10$.Q/4z.a8oZmQiDdzhFtZM.y9XEbUlNVC2gxVoVJjTXpg9wOnlQKQ.');
...
--
-- Volcado de datos para la tabla `prescripcion_final`
--

INSERT INTO `prescripcion_final` (`idPrescripcion_Final`, `OI`, `OD`, `ADD_OD`, `ADD_OI`, `AV_VL_OD`, `AV_VL_OI`, `AV_VP_OD`, `AV_VP_OI`, `DNP_OD`, `DNP_OI`) VALUES
(1, '1.01', '01', '0.1', '1.0', '0.3', '1.0', '0.1', '0.1', '0.2', '2.0'),
(2, '1.0', '1.1', '1.1', '1.000', '1.0', '1.1', '1.2', '1.2', '1.0', '1.0');
...
--
ALTER TABLE `prescripcion_final`
  MODIFY `idPrescripcion_Final` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
